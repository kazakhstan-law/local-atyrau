---
version_id: '191359_677934'
act_code: '191359'
language: kaz
title: Индер ауданы Есбол ауылдық округі жергілікті қоғамдастықтың бөлек жиындарын өткізудің қағидаларын және жергілікті қоғамдастық жиынына қатысу үшін ауылдар тұрғындары өкілдерінің сандық құрамын бекіту туралы
requisite: Атырау облысы Индер аудандық мәслихатының 2023 жылғы 26 желтоқсандағы № 69-VIII шешімі
form: РЕШ
type_codes:
- ПРАВ
- РЕШ
...
source: https://zan.gov.kz/client/#!/doc/191359/kaz
---

# Индер ауданы Есбол ауылдық округі жергілікті қоғамдастықтың бөлек жиындарын өткізудің қағидаларын және жергілікті қоғамдастық жиынына қатысу үшін ауылдар тұрғындары өкілдерінің сандық құрамын бекіту туралы
...
1. Осы шешімнің 1 қосымшасына сәйкес Есбол ауылдық округінің жергілікті қоғамдастықтың бөлек жиындарын өткізудің қағидалары бекітілсін.

2. Осы шешімнің 2 қосымшасына сәйкес Есбол ауылдық округінің жергілікті қоғамдастық жиынына қатысу үшін Есбол, Ынтымақ ауылдарының тұрғындары өкілдерінің сандық құрамы бекітілсін.
...
> *26 желтоқсандағы № 69-VIII*  
> *шешіміне 1 қосымша*

## Индер ауданы Есбол ауылдық округінің жергілікті қоғамдастықтың бөлек жиындарын өткізудің қағидалары

### 1. Жалпы ережелер

1. Осы Индер ауданы Есбол ауылдық округінің жергілікті қоғамдастықтың бөлек жиындарын өткізудің қағидалары «Қазақстан Республикасындағы жергілікті мемлекеттік басқару және өзін-өзі басқару туралы» Қазақстан Республикасы Заңының 39-3 бабы 6-тармағына, Қазақстан Республикасы Ұлттық экономика министрінің 2023 жылғы 23 маусымдағы № 122 «Жергілікті қоғамдастықтың бөлек жиындарын өткізудің үлгілік қағидаларын бекіту туралы» бұйрығына (Қазақстан Республикасының Әділет Министрлігінде № 32894 болып тіркелген) сәйкес әзірленді және Есбол ауылдық округінің ауылдық округ тұрғындарының жергілікті қоғамдастықтың бөлек жиындарын өткізудің тәртібін белгілейді.
...
5. Есбол ауылдық округінің әкімі жергілікті қоғамдастықтың бөлек жиынын шақырады және өткізуді ұйымдастырады.

   Көше шегінде көппәтерлі үйлер болған кезде көппәтерлі үйдің бөлек жиындары жүргізілмейді.

6. Жергілікті қоғамдастықтың бөлек жиындарының шақырылу уақыты, орны және талқыланатын мәселелер туралы жергілікті қоғамдастықтың халқын Есбол ауылдық округінің әкімі бұқаралық ақпарат құралдары арқылы немесе өзге де тәсілдермен өткізілетін күнге дейін күнтізбелік он күннен кешіктірмей хабардар етеді.
...
11. Жергілікті қоғамдастықтың бөлек жиынының хаттамасына төраға мен хатшы қол қояды және бөлек жиын өткізілген күннен бастап екі жұмыс күні ішінде жиын хатшысы тіркеу үшін тиісті Есбол ауылдық округі әкімінің аппаратына береді.
...
## Индер ауданы Есбол ауылдық округінің жергілікті қоғамдастық жиынына қатысу үшін Есбол, Ынтымақ ауыл тұрғындары өкілдерінің сандық құрамы
...
<tr>
<td>1.</td>
<td>Құрманғазы, Е.Ахметов Ғ.Сайханов көшелері</td>
<td>1</td>
</tr>
<tr>
<td>2.</td>
<td>Қ.Есбосынов, Сейфуллин Жамбыл көшелері</td>
<td>1</td>
</tr>
<tr>
<td>3.</td>
<td>Махамбет, И.Тайманов, С.Датов көшелері</td>
<td>1</td>
</tr>
<tr>
<td>4.</td>
<td>Қ.Әліпова,Қ.Сұлтанов, К.Бахитов көшелері</td>
<td>1</td>
</tr>
<tr>
<td>5.</td>
<td>Ш.Иманғазиев, А.Мусагалиев, Қ.Қуанышбаев көшелері</td>
<td>1</td>
</tr>
<tr>
<td>6.</td>
<td>Достық, Ақжар, Қ.Шүйіншқалиев көшелері</td>
<td>1</td>
</tr>
<tr>
<td>7.</td>
<td>М.Әуезов, Н.Сапаров, Б.Нысанбаев көшелері</td>
<td>1</td>
</tr>
<tr>
<td>8.</td>
<td>Д.Нұрпейісов, М.Мөңкеұлы көшесі</td>
<td>1</td>
</tr>
<tr>
<td>9.</td>
...
<tr>
<td>10.</td>
<td>Ынтымақ ауылы Қ.Төремұратов, С.Сейітов, Б.Бозекенов көшелері</td>
<td>1</td>
</tr>
<tr>
